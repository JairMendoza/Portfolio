    ...
    <section ref={sectionRef} className="container mx-auto px-6 py-20 relative">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-center md:items-start">
        ...
        <div className="flex-1 space-y-6 text-center md:text-left">
          ...
          <div
            ref={addToRefs}
            className="space-y-4 text-secondary-foreground text-lg leading-relaxed"
          >
            <p>{t("about.bio1")}</p>
            <p>{t("about.bio2")}</p>
          </div>
          ...
          <div
            ref={addToRefs}
            className="grid grid-cols-2 gap-4 pt-6 border-t border-border mt-8"
          >
            <div className="flex flex-col items-center md:items-start">
              <span className="text-3xl font-black text-primary">30+</span>
              <span className="text-xs text-secondary-foreground uppercase tracking-wider mt-1">
